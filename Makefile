...
compile-pb:
	...
	protoc -I /usr/local/include/ -I pkg/resource/resource_api/resource_api_grpc_pb/ pkg/resource/resource_api/resource_api_grpc_pb/resource_api_grpc_pb.proto --go_out=plugins=grpc:pkg/resource/resource_api/resource_api_grpc_pb
