...
class ProjectResourceVirutal extends Component {
  state = {
    expanded: "IndexPanel",
  };
  ...
  render() {
    ...
    console.log("DEBUG ResourceVirutal")
    console.log(monitor)
...
ProjectResourceVirutal.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(styles)(ProjectResourceVirutal))
