...
func (*StatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_pb_92415bd2e3f72337, []int{0}
}
...
func (*StatusReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_pb_92415bd2e3f72337, []int{1}
}
...
func (c *healthClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, "/grpc_pb.Health/Status", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_pb.Health/Status",
	}
...
func init() { proto.RegisterFile("grpc_pb.proto", fileDescriptor_grpc_pb_92415bd2e3f72337) }

var fileDescriptor_grpc_pb_92415bd2e3f72337 = []byte{
	...
	0x5a, 0x54, 0x64, 0xe4, 0xc4, 0xc5, 0xe6, 0x91, 0x9a, 0x98, 0x53, 0x92, 0x21, 0x64, 0xc1, 0xc5,
	0x06, 0xd1, 0x2c, 0x24, 0xa6, 0x07, 0xb3, 0x10, 0xc5, 0x78, 0x29, 0x11, 0x0c, 0xf1, 0x82, 0x9c,
	0x4a, 0x25, 0x06, 0x27, 0x03, 0x2e, 0xe9, 0xcc, 0x7c, 0xb0, 0x9c, 0x5e, 0x6a, 0x45, 0x62, 0x6e,
	0x41, 0x4e, 0x6a, 0xb1, 0x5e, 0x51, 0x7e, 0x69, 0x49, 0x6a, 0x7a, 0x69, 0x66, 0x4a, 0xaa, 0x13,
	0x7f, 0x10, 0x88, 0xed, 0x0e, 0x62, 0x07, 0x80, 0x3c, 0x10, 0xc0, 0x98, 0xc4, 0x06, 0xf6, 0x89,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x9b, 0x93, 0x21, 0xa7, 0xda, 0x00, 0x00, 0x00,
}
