...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_pb_552e3c398d1430c1, []int{0}
}
...
func (*HealthReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_pb_552e3c398d1430c1, []int{1}
}
...
func init() {
	proto.RegisterType((*HealthRequest)(nil), "grpc_pb.HealthRequest")
	proto.RegisterType((*HealthReply)(nil), "grpc_pb.HealthReply")
}
...
func (c *resourceRegionClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthReply, error) {
	out := new(HealthReply)
	err := c.cc.Invoke(ctx, "/grpc_pb.ResourceRegion/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ResourceRegion_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_pb.ResourceRegion/Health",
	}
...
var _ResourceRegion_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_pb.ResourceRegion",
...
func init() { proto.RegisterFile("grpc_pb.proto", fileDescriptor_grpc_pb_552e3c398d1430c1) }

var fileDescriptor_grpc_pb_552e3c398d1430c1 = []byte{
	...
	0x78, 0x3d, 0x52, 0x13, 0x73, 0x4a, 0x32, 0x82, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x94, 0x0c,
	...
	0x5a, 0x54, 0x64, 0xe4, 0xc5, 0xc5, 0x17, 0x94, 0x5a, 0x9c, 0x5f, 0x5a, 0x94, 0x9c, 0x1a, 0x94,
	0x9a, 0x9e, 0x99, 0x9f, 0x27, 0x64, 0xc1, 0xc5, 0x06, 0x31, 0x44, 0x48, 0x4c, 0x0f, 0x66, 0x31,
	0x8a, 0x35, 0x52, 0x22, 0x18, 0xe2, 0x05, 0x39, 0x95, 0x4a, 0x0c, 0x4e, 0x06, 0x5c, 0xd2, 0x99,
	0xf9, 0x60, 0x39, 0xbd, 0xd4, 0x8a, 0xc4, 0xdc, 0x82, 0x9c, 0xd4, 0x62, 0xbd, 0xa2, 0xfc, 0xd2,
	0x92, 0xd4, 0xf4, 0xd2, 0xcc, 0x94, 0x54, 0x27, 0xfe, 0x20, 0x10, 0xdb, 0x1d, 0xc4, 0x0e, 0x00,
	0x79, 0x24, 0x80, 0x31, 0x89, 0x0d, 0xec, 0x23, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6a,
	0xa5, 0x31, 0xa5, 0xe2, 0x00, 0x00, 0x00,
}
