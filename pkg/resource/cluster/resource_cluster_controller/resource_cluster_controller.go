...
func (server *ResourceClusterControllerServer) StartMainLoop() error {
	go server.MainLoop()
	return nil
}

func (server *ResourceClusterControllerServer) MainLoop() error {
...
func (server *ResourceClusterControllerServer) Serv() error {
...
func (server *ResourceClusterControllerServer) GracefulShutdown(ctx context.Context) error {
