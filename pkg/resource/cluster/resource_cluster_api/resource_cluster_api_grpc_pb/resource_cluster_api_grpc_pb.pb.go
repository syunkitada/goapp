...
package resource_cluster_api_grpc_pb // import "github.com/syunkitada/goapp/pkg/resource/cluster/resource_cluster_api/resource_cluster_api_grpc_pb"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import authproxy_grpc_pb "github.com/syunkitada/goapp/pkg/authproxy/authproxy_grpc_pb"
import resource_api_grpc_pb "github.com/syunkitada/goapp/pkg/resource/resource_api/resource_api_grpc_pb"
...
func (*StatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{0}
}
...
func (*StatusReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{1}
}
...
func (*ActionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{2}
}
...
func (*ActionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{3}
}
...
func (*UpdateNodeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{4}
}
...
func (*UpdateNodeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{5}
}
...
//
type Node struct {
	Node                 *resource_api_grpc_pb.Node `protobuf:"bytes,1,opt,name=node" json:"node,omitempty"`
	Labels               string                     `protobuf:"bytes,2,opt,name=Labels" json:"Labels,omitempty"`
	DriverLabels         string                     `protobuf:"bytes,3,opt,name=DriverLabels" json:"DriverLabels,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{6}
}
...
type Compute struct {
	Compute              *resource_api_grpc_pb.Compute `protobuf:"bytes,1,opt,name=compute" json:"compute,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (*Compute) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe, []int{7}
}
...
func init() {
	proto.RegisterFile("resource/cluster/resource_cluster_api/resource_cluster_api_grpc_pb/resource_cluster_api_grpc_pb.proto", fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe)
}

var fileDescriptor_resource_cluster_api_grpc_pb_297e07b3c2141abe = []byte{
